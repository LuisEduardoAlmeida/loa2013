...
type
  TfrmUnoQDD = class(TForm)
    ...
    procedure ColumnHeaderBand1BeforePrint(Sender: TQRCustomBand;
      var PrintBand: Boolean);
    procedure footerBandAfterPrint(Sender: TQRCustomBand;
      BandPrinted: Boolean);
  private
...
procedure TfrmUnoQDD.ChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TfrmUnoQDD.ChildBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  printBand := qryLocali.fieldByname('meta').asString <> '';
end;

procedure TfrmUnoQDD.ColumnHeaderBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
   lbano.Caption := ' - Exercício '+qryParametroexercicio.AsString;
end;

procedure TfrmUnoQDD.ColumnHeaderBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
   if pulapage = true then report.NewPage;
   lbano.Caption := ' - Exercício '+qryParametroexercicio.AsString;
end;

procedure TfrmUnoQDD.footerBandAfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
    pulapage := False;
end;
