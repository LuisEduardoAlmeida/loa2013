...
type
  TfrmOrgNatDesp = class(TForm)
    ...
    qryCatorgao: TStringField;
    qryGrupoorgao: TStringField;
    qrySubGrupoorgao: TStringField;
...
procedure TfrmOrgNatDesp.detailBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  printBand := qryCat.fieldByName('cat').asString <> '0';
end;

procedure TfrmOrgNatDesp.sdtGrupoBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  printBand := qryGrupo.fieldByName('grupo').asString <> '0';
end;

procedure TfrmOrgNatDesp.sdtSubGrupoBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
