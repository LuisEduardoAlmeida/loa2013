...
begin
  ...
  if treeMenu.selected.text = 'Importação de Arquivos' then begin
     frmFileImport.setBounds(frmMain.left + 240, frmMain.top + 167,803,562);
     frmFileImport.showModal;
  end;
  if treeMenu.selected.text = 'Ações' then begin
  ...
  if treeMenu.selected.text = 'Funções' then begin
     frmFuncao.setBounds(frmMain.left + 240, frmMain.top + 167,803,562);
     frmFuncao.showModal;
  end;
  if treeMenu.selected.text = 'Subfunções' then begin
  ...
  if treeMenu.selected.text = 'Órgãos' then begin
     frmOrgao.setBounds(frmMain.left + 240, frmMain.top + 167,803,562);
     frmOrgao.showModal;
  end;
  if treeMenu.selected.text = 'Unidades Orçamentárias' then begin
  ...
  if treeMenu.selected.text = 'Evolução da Receita' then begin
     frmEvolRec.setBounds(frmMain.left + 240, frmMain.top + 167,803,562);
     frmEvolRec.showModal;
  end;
  if treeMenu.selected.text = 'Evolução da Despesa' then begin
  ...
  if treeMenu.selected.text = 'Configuração de Parâmetros' then begin
  ...
  if treeMenu.selected.text = 'Consolidados do Órgão' then begin
     frmOrgaoDial.setBounds(frmMain.left + 240, frmMain.top + 167,803,562);
     frmOrgaoDial.showModal;
  end;

  if treeMenu.selected.text = 'Consolidados da Unidade Orçamentária' then begin
     frmUnoDial.setBounds(frmMain.left + 240, frmMain.top + 167,803,562);
     IndUso := 'N';
     frmUnoDial.showModal;
  end;

  if treeMenu.selected.text = 'Consolidados da Unidade Orçamentária - INDUSO' then begin
     frmUnoDial.setBounds(frmMain.left + 240, frmMain.top + 167,803,562);
     IndUso := 'S';
     frmUnoDial.showModal;
  end;

  if treeMenu.selected.text = 'Consolidados da Unidade Orçamentária - Gerencial' then
  begin
  ...
  if treeMenu.selected.text = 'Geração' then
  begin
     frmBackup.setBounds(frmMain.left + 240, frmMain.top + 167,803,562);
     frmBackup.showModal;
  end;

  if treeMenu.selected.text = 'Restauração' then
  begin
  ...
  if treeMenu.selected.text = 'Por Função' then
  begin
...
{ -- Relatórios -- }
  ...
  if treeMenu.selected.text = 'Quadro da Evolução da Receita' then
  begin
  ...
  if treeMenu.selected.text = 'Quadro da Evolução da Despesa' then begin
     Application.CreateForm(TfrmConsEvolDesp, frmConsEvolDesp);
     frmConsEvolDesp.report.preview;
     frmConsEvolDesp.free;
  end;

  if treeMenu.selected.text = 'Demonstrativo da Destinação da Receita' then
  begin
  ...
  if treeMenu.selected.text = 'Demonstrativo da Receita Segundo sua Destinação' then
  begin
  ...
  if treeMenu.selected.text = 'Demonstrativo da Receita por Categoria Econômica' then
  begin
  ...
  if treeMenu.selected.text = 'Regionalização das Aplicações' then begin
     Application.CreateForm(TfrmConsRegional, frmConsRegional);
     frmConsRegional.report.preview;
     frmConsRegional.free;
  end;

  if treeMenu.selected.text = 'Demonstrativo das Receitas Diretamente Arrecadadas por Órgão/Unidade' then begin
     Application.CreateForm(TfrmConsRecArrec02, frmConsRecArrec02);
     frmConsRecArrec02.preview;
     frmConsRecArrec02.free;
  end;

  if treeMenu.selected.text = 'Demonstrativo das Receitas Diretamente Arrecadadas por Órgão/Unidade - Gerencial' then begin
  ...
  if treeMenu.selected.text = 'Demonstrativo da Despesa por Categoria Econômica e Grupo de Despesa' then begin
     Application.CreateForm(TfrmConsDespCat, frmConsDespCat);
     frmConsDespCat.report.preview;
     frmConsDespCat.free;
  end;

  if treeMenu.selected.text = 'Demonstrativo da Despesa por Categoria Econômica e Grupo de Despesa - Diretas' then begin
  ...
  if treeMenu.selected.text = 'Demonstrativo da Despesa por Categoria Econômica e Grupo de Despesa - Indiretas' then begin
  ...
  if treeMenu.selected.text = 'Ações e Serviços de Saúde' then
  begin
     Application.CreateForm(TfrmConsDensEns, frmConsDensEns);
     with frmConsDensEns do
     begin
  ...
  if treeMenu.selected.text = 'Ações e Serviços de Assistência Social' then begin
     Application.CreateForm(TfrmConsDensEns, frmConsDensEns);
  ...
  if treeMenu.selected.text = 'Demonstrativo da Despesa com Pessoal em Relação à Receita Corrente Líquida' then begin
  ...
  if treeMenu.selected.text = 'Emendas com diferença entre Geral e Detalhamento' then
  begin
  ...
  if treeMenu.selected.text = 'Redução e Acréscimo' then
  begin
  ...
  if treeMenu.selected.text = 'Projeção do Ano Seguinte' then begin
  ...
  if treeMenu.selected.text = 'Conform Rec/Desp Intra Orçamentária' then begin
  ...
  // Impressão de Relatórios
  if treeMenu.selected.text = 'EMENDAS APROVADAS EM 1º DISCUSSÃO - ORDERM DE EMENDAS' then begin
  ...
  if treeMenu.selected.text = 'EMENDAS APROVADAS EM 1º DISCUSSÃO - [GERAL] POR VEREADOR' then begin
  ...
  if treeMenu.selected.text = 'Impressão de Rel. das Unid. Orçamentária' then begin
  ...
  if treeMenu.selected.text = 'Impressão de Rel. Geral' then begin
  ...
  // Impressão de Relatórios dos Órgãos
  if treeMenu.selected.text = 'Impressão de Rel. dos Órgãos' then begin
  ...
  if treeMenu.selected.text = 'Pesquisa Analítica Despesa' then begin
    ...
    if treeMenu.selected.text = 'Pesquisa Analítica Receita' then begin
...
begin
   ...
   StatusBar1.Panels[0].Text := 'Ano de Exercício: '+Ano_Exercicio;
   lbAnoExercicio.Caption    := 'LOA - LEI ORÇAMENTÁRIA ANUAL - '+Ano_Exercicio;
   PermLogon := 'N';
   Autoriza := 'N';
end;
