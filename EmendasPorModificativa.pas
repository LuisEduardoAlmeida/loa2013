...
type
  TFrmEmendasPorModificativa = class(TQuickRep)
    QRBand1: TQRBand;
    ADOQuery1: TADOQuery;
    QRGroup1: TQRGroup;
    QRDBText1: TQRDBText;
...
var
  FrmEmendasPorModificativa: TFrmEmendasPorModificativa;
...
procedure TFrmEmendasPorModificativa.QRBand3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
   sombra.enabled := not(sombra.enabled); 
end;

procedure TFrmEmendasPorModificativa.QRGroup1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
