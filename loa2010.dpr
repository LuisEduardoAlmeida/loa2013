...
uses
  ...
  portaria in 'C:\teste\portaria.pas' {frmPortaria},
  ...
  PesquisaAnalitica in 'PesquisaAnalitica.pas' {frmPesqAnalitica},
...
begin
  ...
  Application.CreateForm(TFrmRelConsul, FrmRelConsul);
  frmLogIn.showModal;
