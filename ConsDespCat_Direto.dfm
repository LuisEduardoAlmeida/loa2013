object frmConsDespCat_Direto: TfrmConsDespCat_Direto
  Left = 0
  Top = 192
  Width = 1024
  Height = 474
  ...
  object report: TQuickRep
    ...
    object QRBand1: TQRBand
      ...
      object QRExpr3: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39',SUM(qryCat.total)+qryCat02.total)'
        FontSize = 8
      end
  ...
  object qry: TADOQuery
    ...
    SQL.Strings = (
      ...
      '      WHERE cat = :cat'
        ...
        '      and substring(unorc,3,1) = '#39'1'#39'  and substring(unorc,1,1) <' +
        '> '#39'9'#39' '
  ...
  object qryCat02: TADOQuery
    ...
    SQL.Strings = (
      ...
      '    INNER JOIN elDespesa e ON o.catD = e.codigo'
        ...
        '  where substring(unorc,3,1) = '#39'1'#39' AND substring(unorc,1,1) = '#39'9' +
        #39
      '      GROUP BY cat, catD, e.descricao'
      '      ORDER BY cat')
    Left = 104
