object frmEvolDesp: TfrmEvolDesp
  Left = 126
  Top = 106
  ...
  object Label1: TLabel
    ...
    Height = 16
    Alignment = taCenter
    Caption = 'TABELA DE EVOLU'#199#195'O DA DESPESA'
  ...
  object qry: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM evolDesp ORDER BY codigo')
    Left = 40
    Top = 508
    ...
    object qryelDespesa2: TStringField
      FieldKind = fkLookup
      FieldName = 'elDespesa'
      LookupDataSet = qryElDespesa
  ...
  object qryElDespesa: TADOQuery
    Active = True
    Connection = dmtData.adoCon
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM elDespesa ORDER BY descricao')
    Left = 136
    Top = 508
  end
