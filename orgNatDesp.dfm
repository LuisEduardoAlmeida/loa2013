object frmOrgNatDesp: TfrmOrgNatDesp
  Left = 236
  Top = 178
  Width = 693
  Height = 479
  HorzScrollBar.Position = 73
  ...
  object qryCat: TADOQuery
    ...
    object qryCatorgao: TStringField
      FieldName = 'orgao'
      Size = 2
    end
  end
  ...
  object qryGrupo: TADOQuery
    ...
    SQL.Strings = (
      'SELECT orgao, cat, grupo, grupoD, despesaD = e.descricao,'
      '       total = SUM(valor),'
      '       fiscal = SUM(fiscal),'
      '       seguridade = SUM(seguridade)  '
      ' FROM orcamento o'
      ...
      '      GROUP BY orgao, cat, grupo, grupoD, e.descricao'
      '          ORDER BY grupo')
    Left = 40
    Top = 8
    ...
    object qryGrupoorgao: TStringField
      FieldName = 'orgao'
      Size = 2
    end
  end
  ...
  object qrySubGrupo: TADOQuery
    ...
    SQL.Strings = (
      'SELECT orgao, cat, grupo, mod, modD, despesaD = e.descricao,'
      '       total = SUM(valor),'
      '       fiscal = SUM(fiscal),'
      '       seguridade = SUM(seguridade)  '
      ' FROM orcamento o'
      '   INNER JOIN elDespesa e ON o.modD = e.codigo'
      '        WHERE cat = :cat AND grupo = :grupo AND orgao = :orgao'
      '      GROUP BY orgao, cat, grupo, mod, modD, e.descricao'
      '          ORDER BY mod')
    Left = 72
    Top = 8
    ...
    object qrySubGrupoorgao: TStringField
      FieldName = 'orgao'
      Size = 2
    end
  end
  ...
  object qry: TADOQuery
    ...
    SQL.Strings = (
      ...
      '   INNER JOIN elDespesa e ON o.elDespesa = e.codigo'
        ...
        '        WHERE cat = :cat AND grupo = :grupo AND mod = :mod AND o' +
        'rgao = :orgao'
