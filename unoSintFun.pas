...
procedure TfrmUnoSintFun.reportBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qryColUm.close;
  qryColDois.close;
...
procedure TfrmUnoSintFun.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
