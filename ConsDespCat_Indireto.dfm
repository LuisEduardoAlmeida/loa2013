object frmConsDespCat_Indireto: TfrmConsDespCat_Indireto
  Left = 0
  Top = 192
  Width = 1024
  Height = 479
  ...
  object report: TQuickRep
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel44: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          'DEMONSTRATIVO  DA DESPESA POR CATEGORIA ECON'#212'MICA E GRUPO DE DES' +
          'PESA - INDIRETAS'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
    ...
    object QRBand1: TQRBand
      ...
      object QRExpr7: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39',SUM(qryCat.segOutras))'
        FontSize = 8
      end
      object QRExpr8: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39',SUM(qryCat.segTesouro))'
        FontSize = 8
      end
      object QRExpr9: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39',SUM(qryCat.segTotal))'
        FontSize = 8
      end
      object QRExpr10: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39',SUM(qryCat.fisOutras))'
        FontSize = 8
      end
      object QRExpr11: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39',SUM(qryCat.fisTesouro))'
        FontSize = 8
      end
      object QRExpr12: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39',SUM(qryCat.fisTotal))'
        FontSize = 8
      end
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39',SUM(qryCat.Outras))'
        FontSize = 8
      end
      object QRExpr2: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39',SUM(qryCat.tesouro))'
        FontSize = 8
      end
      ...
      object QRLabel3: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = 'Dedu'#231#245'es das Obrig. Patronais - Interf Financeiras'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
      ...
      object QRExpr5: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(qryCat.fisTesouro)-ADOQuery1.valor'
        Mask = '#,###,###,###'
        FontSize = 8
      end
      ...
      object QRExpr15: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(qryCat.fisTesouro)-ADOQuery1.valor+SUM(qryCat.segTesouro)'
        Mask = '#,###,###,###'
        FontSize = 8
      end
      object QRExpr6: TQRExpr
        ...
        WordWrap = True
        Expression = 
          'SUM(qryCat.fisTesouro)-ADOQuery1.valor+SUM(qryCat.segTesouro)+SU' +
          'M(qryCat.Outras)'
        Mask = '#,###,###,###'
        FontSize = 8
      end
      object QRExpr14: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(qryCat.fisTesouro)-ADOQuery1.valor+SUM(qryCat.fisOutras)'
        Mask = '#,###,###,###'
        FontSize = 8
      end
  ...
  object qryCat: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'SELECT cat, catD, despesaD = e.descricao,'
      '       total = SUM(valor),'
      '       tesouro = SUM(tesouro),'
      '       outras = SUM(outrasF),'
      '       fisTotal = SUM(fiscal),'
      ...
      '    INNER JOIN elDespesa e ON o.catD = e.codigo'
        ...
        '  where substring(unorc,3,1) <> '#39'1'#39' AND substring(unorc,1,1) <> ' +
        #39'9'#39
  ...
  object qry: TADOQuery
    ...
    Prepared = True
    SQL.Strings = (
      'SELECT cat, grupo, grupoD, despesaD = e.descricao,'
      '       total = SUM(valor),'
      '       tesouro = SUM(tesouro),'
      '       outras = SUM(outrasF),'
      '       fisTotal = SUM(fiscal),'
      ...
      '    INNER JOIN elDespesa e ON o.grupoD = e.codigo'
        ...
        '      WHERE cat = :cat and substring(unorc,3,1) <> '#39'1'#39' AND subst' +
        'ring(unorc,1,1) <> '#39'9'#39
      ''
