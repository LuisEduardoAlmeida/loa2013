object frmConsDespOrgao: TfrmConsDespOrgao
  Left = 4
  Top = 133
  Width = 984
  Height = 564
  ...
  object report: TQuickRep
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel44: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'DEMONSTRATIVO DA DESPESA POR '#211'RG'#195'O'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
    ...
    object QRBand1: TQRBand
      ...
      object QRExpr7: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39',SUM(qryOrgao.amortiza))'
        FontSize = 8
      end
      object QRExpr8: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39',SUM(qryOrgao.invFin))'
        FontSize = 8
      end
      object QRExpr9: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39',SUM(qryOrgao.invest))'
        FontSize = 8
      end
      object QRExpr10: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39',SUM(qryOrgao.outras))'
        FontSize = 8
      end
      object QRExpr11: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39',SUM(qryOrgao.juros))'
        FontSize = 8
      end
      object QRExpr12: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39',SUM(qryOrgao.pessoal))'
        FontSize = 8
      end
  ...
  object qry: TADOQuery
    ...
    Prepared = True
    SQL.Strings = (
      'SELECT orgao, unorc, unorcD,fonte,'
      '       pessoal = SUM(pessoal),'
      '       juros = SUM(juros),'
      '       outras = SUM(outras),'
      '       invest = SUM(invest),'
      ...
      '     FROM orcamento '
      '       WHERE orgao = :orgao '
      '  GROUP BY orgao, unorc, unorcD,fonte'
      '  ORDER BY unorc ')
    Left = 40
    Top = 8
  end
