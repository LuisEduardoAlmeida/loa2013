...
type
  TfrmUnoQDDTodos = class(TForm)
    ...
    qryEsferaesferaD: TStringField;
    qryEsferatotal: TBCDField;
    qryProgunorc: TStringField;
    qryProgesfera: TStringField;
    qryProgprograma: TStringField;
    qryProgprogramaD: TStringField;
    qryProgtotal: TBCDField;
    ...
    procedure ColumnHeaderBand1AfterPrint(Sender: TQRCustomBand;  BandPrinted: Boolean);
...
var
  frmUnoQDDTodos: TfrmUnoQDDTodos;
...
procedure TfrmUnoQDDTodos.ChildBand1BeforePrint(Sender: TQRCustomBand;
...
procedure TfrmUnoQDDTodos.ChildBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  printBand := qryLocali.fieldByname('meta').asString <> '';
end;

procedure TfrmUnoQDDTodos.ColumnHeaderBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
   lbano.Caption := ' - Exercício '+qryParametroexercicio.AsString;
   lbesferad.Caption := qryEsferaesferaD.Value;
end;

procedure TfrmUnoQDDTodos.ColumnHeaderBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
   lbano.Caption := ' - Exercício '+qryParametroexercicio.AsString;
   lbesferad.Caption := qryEsferaesferaD.Value;
