object frmConsRecDespTot: TfrmConsRecDespTot
  Left = 0
  Top = 123
  Width = 1024
  Height = 607
  ...
  object report: TQuickRep
    ...
    object DetailBand1: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        WordWrap = True
        Expression = 
          'FORMATNUMERIC('#39'#,###,###,###'#39', (qry.recCorr - qry.recDeducao) - ' +
          'qry.despCorr)'
        FontSize = 8
      end
      ...
      object QRExpr5: TQRExpr
        ...
        WordWrap = True
        Expression = 
          'FORMATNUMERIC('#39'#,###,###,###'#39', qry.despCap + qry.reserva - qry.r' +
          'ecIntCor)'
        FontSize = 8
      end
      ...
      object QRExpr17: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = '(qry.despCorr+qry.despCap+qry.reserva)'
        Mask = '#,###,###,###'
        FontSize = 8
      end
