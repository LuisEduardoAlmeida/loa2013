object frmConsFonteGrupo: TfrmConsFonteGrupo
  Left = 72
  Top = 197
  Width = 1030
  Height = 480
  HorzScrollBar.Position = 127
  ...
  object report: TQuickRep
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel44: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'DEMONSTRATIVO DAS FONTES DE RECURSOS POR GRUPO DE DESPESA'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
  ...
  object qryTot: TADOQuery
    ...
    Left = 8
    Top = 8
    object qryTotrecurso: TStringField
      FieldName = 'recurso'
      Size = 1
    end
    object qryTotrecursoD: TStringField
      FieldName = 'recursoD'
      Size = 25
    end
    object qryTotpessoal: TBCDField
      FieldName = 'pessoal'
      ReadOnly = True
      Precision = 19
    end
    object qryTotjuros: TBCDField
      FieldName = 'juros'
      ReadOnly = True
      Precision = 19
    end
    object qryTotoutras: TBCDField
      FieldName = 'outras'
      ReadOnly = True
      Precision = 19
    end
    object qryTotinvest: TBCDField
      FieldName = 'invest'
      ReadOnly = True
      Precision = 19
    end
    object qryTotinvFin: TBCDField
      FieldName = 'invFin'
      ReadOnly = True
      Precision = 19
    end
    object qryTotamortiza: TBCDField
      FieldName = 'amortiza'
      ReadOnly = True
      Precision = 19
    end
    object qryTottotal: TBCDField
      FieldName = 'total'
      ReadOnly = True
      Precision = 19
    end
