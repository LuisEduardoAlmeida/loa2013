...
type
  TfrmConsDespCat_Direto = class(TForm)
    report: TQuickRep;
...
var
  frmConsDespCat_Direto: TfrmConsDespCat_Direto;
...
procedure TfrmConsDespCat_Direto.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TfrmConsDespCat_Direto.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
