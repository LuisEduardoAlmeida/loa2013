object frmReducaoPesq: TfrmReducaoPesq
  Left = 301
  Top = 238
  Width = 409
  Height = 291
  Caption = 'Pesquisa de Redu'#231#227'o'
  Color = clBtnFace
  ...
  object edVereador: TEdit
    ...
    MaxLength = 5
    TabOrder = 2
    OnChange = edVereadorChange
    OnExit = edVereadorExit
  end
  object cmbVereador: TComboBox
    Left = 52
    Top = 70
    Width = 341
    Height = 21
    ...
    TabOrder = 3
    TabStop = False
    OnChange = cmbVereadorChange
    OnClick = cmbVereadorClick
    Items.Strings = (
      '10 - Fiscal'
      '20 - Seguridade')
  end
