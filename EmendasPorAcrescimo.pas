...
type
  TFrmEmendasPorAcrescimo = class(TQuickRep)
    QRBand1: TQRBand;
    ADOQuery1: TADOQuery;
...
var
  FrmEmendasPorAcrescimo: TFrmEmendasPorAcrescimo;
...
procedure TFrmEmendasPorAcrescimo.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
   sombra.enabled := not(sombra.enabled); 
end;

procedure TFrmEmendasPorAcrescimo.QRGroup1BeforePrint(
