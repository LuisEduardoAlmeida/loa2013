object frmUnoQDD_Geral: TfrmUnoQDD_Geral
  Left = 0
  Top = 109
  Width = 1024
  Height = 629
  ...
  object qryAcao: TADOQuery
    ...
    SQL.Strings = (
      ...
      '       total = SUM(valor)'
      '    FROM orcamento o'
      '        WHERE esfera = :esfera AND programa = :programa'
      
        '      GROUP BY unorc, esfera, programa, acao, acaoD, funcao, sub' +
        'Funcao, produto'
  ...
  object qryLocali: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT unorc, esfera, programa, acao, funcao, subFuncao, meta, l' +
        'ocaliS, descricao, locali,'
      ...
      '    FROM orcamento o'
        ...
        '        WHERE esfera = :esfera AND programa = :programa AND acao' +
        ' = :acao'
      
        '      GROUP BY unorc, esfera, programa, acao, funcao, subFuncao,' +
