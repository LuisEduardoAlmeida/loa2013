...
var
  frmConsDespCat: TfrmConsDespCat;
...
procedure TfrmConsDespCat.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TfrmConsDespCat.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
