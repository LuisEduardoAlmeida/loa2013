...
type
  TfrmUnoNatDesp = class(TForm)
    ...
    QRDBText4: TQRDBText;
    QRDBText5: TQRDBText;
    qrySubGrupounorc: TStringField;
    qryGrupounorc: TStringField;
...
procedure TfrmUnoNatDesp.detailBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  printBand := qryCat.fieldByName('cat').asString <> '0';
end;

procedure TfrmUnoNatDesp.sdtGrupoBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  printBand := qryGrupo.fieldByName('grupo').asString <> '0';
end;

procedure TfrmUnoNatDesp.sdtSubGrupoBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
