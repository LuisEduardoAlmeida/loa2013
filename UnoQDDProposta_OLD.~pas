...
type
  TfrmUnoQDDProposta_old = class(TForm)
    report: TQuickRep;
...
var
  frmUnoQDDProposta_old: TfrmUnoQDDProposta_old;
...
procedure TfrmUnoQDDProposta_old.ChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TfrmUnoQDDProposta_old.ChildBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  printBand := qryLocali.fieldByname('meta').asString <> '';
end;

procedure TfrmUnoQDDProposta_old.ColumnHeaderBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
   lbano.Caption := ' - Exercício '+qryParametroexercicio.AsString;
end;

procedure TfrmUnoQDDProposta_old.ColumnHeaderBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
   lbano.Caption := ' - Exercício '+qryParametroexercicio.AsString;
end;
