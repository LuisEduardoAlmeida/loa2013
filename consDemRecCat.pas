...
var
  frmConsDemRecCat: TfrmConsDemRecCat;
...
procedure TfrmConsDemRecCat.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TfrmConsDemRecCat.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
