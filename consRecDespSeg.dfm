object frmConsRecDespSeg: TfrmConsRecDespSeg
  Left = 0
  Top = 102
  Width = 1024
  Height = 636
  ...
  object report: TQuickRep
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel44: TQRLabel
        ...
        Caption = 
          ...
          #212'MICAS - OR'#199'AMENTO DA SEGURIDADE SOCIAL'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
    ...
    object DetailBand1: TQRBand
      ...
      object QRExpr5: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39', qry.despCap)'
        FontSize = 8
      end
      ...
      object QRExpr6: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39', qry.despCorr + qry.despCap)'
        FontSize = 8
      end
      ...
      object QRLabel48: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'TRANSFER'#202'NCIA DO OR'#199'AMENTO FISCAL'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
      ...
      object QRExpr8: TQRExpr
        ...
        WordWrap = True
        Expression = 
          'FORMATNUMERIC('#39'#,###,###,###'#39', (qry.recCorr + qry.transferencia+' +
          'qry.recIntCor))'
        FontSize = 8
      end
      ...
      object QRExpr4: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'#,###,###,###'#39', qry.superAvit + qry.recCap20)'
        FontSize = 8
      end
      object QRExpr3: TQRExpr
        ...
        WordWrap = True
        Expression = 
          'FORMATNUMERIC('#39'#,###,###,###'#39', (qry.recIntCor+qry.recCorr+qry.tr' +
          'ansferencia))'
        FontSize = 8
      end
      ...
      object QRLabel2: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'TRANSF. OR'#199'.SEGURIDADE'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
  ...
  object qry: TADOQuery
    ...
    SQL.Strings = (
      'SELECT  '
        ...
        '       recCorr = (SELECT SUM(valor) FROM receita WHERE cat = '#39'1'#39 +
        ' AND esfera = '#39'20'#39'),'
      
        '       recCTri = (SELECT SUM(valor) FROM receita WHERE cat = '#39'1'#39 +
        ' AND grupo = '#39'1'#39' AND esfera = '#39'20'#39'),'
      
        '       recCCon = (SELECT SUM(valor) FROM receita WHERE cat = '#39'1'#39 +
        ' AND grupo = '#39'2'#39' AND esfera = '#39'20'#39'),'
      
        '       recCPatr = (SELECT SUM(valor) FROM receita WHERE cat = '#39'1' +
        #39' AND grupo = '#39'3'#39' AND esfera = '#39'20'#39'),'
      
        '       recCServ = (SELECT SUM(valor) FROM receita WHERE cat = '#39'1' +
        #39' AND grupo = '#39'6'#39' AND esfera = '#39'20'#39'),'
      
        '       recCTransf = (SELECT SUM(valor) FROM receita WHERE cat = ' +
        #39'1'#39' AND grupo = '#39'7'#39' AND esfera = '#39'20'#39'),'
      
        '       recCOutra = (SELECT SUM(valor) FROM receita WHERE cat = '#39 +
        '1'#39' AND grupo = '#39'9'#39' AND esfera = '#39'20'#39'),'
      
        '       recIntCor = (SELECT SUM(valor) FROM receita WHERE cat = '#39 +
        '7'#39' and esfera = '#39'20'#39' ), '
      
        '       despCorr = (SELECT SUM(valor) FROM orcamento WHERE cat = ' +
        #39'3'#39' AND esfera = '#39'20'#39'),'
      
        '       despCPess = (SELECT SUM(valor) FROM orcamento WHERE cat =' +
        ' '#39'3'#39' AND grupo = '#39'1'#39' AND esfera = '#39'20'#39'),'
      
        '       despCJuros = (SELECT SUM(valor) FROM orcamento WHERE cat ' +
        '= '#39'3'#39' AND grupo = '#39'2'#39' AND esfera = '#39'20'#39'),'
      
        '       despCOutras = (SELECT SUM(valor) FROM orcamento WHERE cat' +
        ' = '#39'3'#39' AND grupo = '#39'3'#39' AND esfera = '#39'20'#39'),'
      ''
      ...
      ''
        ...
        #39' AND grupo = '#39'1'#39' AND esfera = '#39'20'#39'),'
      
        '       recAAlien = (SELECT SUM(valor) FROM receita WHERE cat = '#39 +
        '2'#39' AND grupo = '#39'2'#39' AND esfera = '#39'20'#39'),'
      
        '       recATransf = (SELECT SUM(valor) FROM receita WHERE cat = ' +
        #39'2'#39' AND grupo = '#39'4'#39' AND esfera = '#39'20'#39'),'
      ''
      
        '       despCap = (SELECT SUM(valor) FROM orcamento WHERE cat = '#39 +
        '4'#39' AND esfera = '#39'20'#39'),'
      
        '       despAInv = (SELECT SUM(valor) FROM orcamento WHERE cat = ' +
        #39'4'#39' AND grupo = '#39'4'#39' AND esfera = '#39'20'#39'),'
      
        '       despAInFin = (SELECT SUM(valor) FROM orcamento WHERE cat ' +
        '= '#39'4'#39' AND grupo = '#39'5'#39' AND esfera = '#39'20'#39'),'
      
        '       despAAmor = (SELECT SUM(valor) FROM orcamento WHERE cat =' +
        ' '#39'4'#39' AND grupo = '#39'6'#39' AND esfera = '#39'20'#39'),'
      ''
      
        '       recCap20 = (SELECT SUM(valor) FROM receita WHERE cat = '#39'2' +
        #39' AND esfera = '#39'20'#39'),'
      ''
      
        '       recCorr10 = (SELECT SUM(valor) FROM receita WHERE cat = '#39 +
        '1'#39' AND esfera = '#39'10'#39'),'
      
        '       recCap10 = (SELECT SUM(valor) FROM receita WHERE cat = '#39'2' +
        #39' AND esfera = '#39'10'#39'),'
      
        '       recDeducao10 = (SELECT SUM(valor) FROM receita WHERE cat ' +
        '= '#39'9'#39' AND esfera = '#39'10'#39'),'
      
        '       despCorr10 = (SELECT SUM(valor) FROM orcamento WHERE cat ' +
        '= '#39'3'#39' AND esfera = '#39'10'#39'),'
      
        '       despCap10 = (SELECT SUM(valor) FROM orcamento WHERE cat =' +
        ' '#39'4'#39' AND esfera = '#39'10'#39'),'
      
        '       reserva10 = (SELECT SUM(valor) FROM orcamento WHERE cat =' +
        ' '#39'9'#39' AND esfera = '#39'10'#39'),'
      
        '       recIntCor10 = (SELECT SUM(valor) FROM receita WHERE cat =' +
        ' '#39'7'#39' and esfera = '#39'10'#39' )  '
      ''
      ''
      ' '
      '   FROM parametro')
    ...
    object qryrecCorr10: TBCDField
      FieldName = 'recCorr10'
      ReadOnly = True
      Precision = 19
    end
    object qryrecCap10: TBCDField
      FieldName = 'recCap10'
      ReadOnly = True
      Precision = 19
    end
    object qryrecDeducao10: TBCDField
      FieldName = 'recDeducao10'
      ReadOnly = True
      Precision = 19
    end
    object qrydespCorr10: TBCDField
      FieldName = 'despCorr10'
      ReadOnly = True
      Precision = 19
    end
    object qrydespCap10: TBCDField
      FieldName = 'despCap10'
      ReadOnly = True
      Precision = 19
    end
    object qryreserva10: TBCDField
      FieldName = 'reserva10'
      ReadOnly = True
      Precision = 19
    end
    ...
    object qryrecCap20: TBCDField
      FieldName = 'recCap20'
      ReadOnly = True
      Precision = 19
    end
    object qryrecIntCor10: TBCDField
      FieldName = 'recIntCor10'
      ReadOnly = True
      Precision = 19
    end
  end
