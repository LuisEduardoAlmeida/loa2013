...
begin
    ...
    Begin
       ShowMessage('Por Favor, informe o número da emenda!!!');
       txtemenda.SetFocus;
       exit;
    End;
    ...
    Begin
       ShowMessage('Por Favor, informe a Votação!!!');
       cbVotacao.SetFocus;
       exit;
    End;
...
begin
   ...
   Begin
      ...
      ShowMessage('Atenção!!!'+#13+
                  'Esta emenda não pode ser apagada pois existe detalhamentos para a mesma.'+#13+
   ...
   If MessageBox (Application.Handle, Pchar ('CONFIRMA A EXCLUSÃO DE DADOS ?'), 'EXCLUSÃO',
       MB_YESNO+MB_ICONEXCLAMATION+MB_DEFBUTTON1) = idNo Then Exit;
...
begin
   ...
   begin
      HideWarning;
      ShowMessage('NENHUMA INFORMAÇÃO FOI ENCONTRADA COM OS DADOS FORNECIDOS.');
      EXIT;
   end;
