object frmUnoQDDTodos: TfrmUnoQDDTodos
  Left = 0
  Top = 91
  Width = 1024
  Height = 629
  ...
  object qryEsfera: TADOQuery
    ...
    object qryEsferaesfera: TStringField
      FieldName = 'esfera'
      Size = 2
    end
    object qryEsferaesferaD: TStringField
      FieldName = 'esferaD'
      Size = 30
    end
  ...
  object qryProg: TADOQuery
    ...
    Left = 420
    Top = 8
    object qryProgunorc: TStringField
      FieldName = 'unorc'
      Size = 5
    end
    object qryProgesfera: TStringField
      FieldName = 'esfera'
      Size = 2
    end
    object qryProgprograma: TStringField
      FieldName = 'programa'
      Size = 4
    end
    object qryProgprogramaD: TStringField
      FieldName = 'programaD'
      Size = 255
    end
    object qryProgtotal: TBCDField
      FieldName = 'total'
      ReadOnly = True
      Precision = 19
    end
