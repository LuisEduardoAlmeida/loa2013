...
var
  frmUnoQDDGerRel: TfrmUnoQDDGerRel;

implementation

uses data, unoDial, UnoDialGerRel;

{$R *.DFM}

procedure TfrmUnoQDDGerRel.ChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TfrmUnoQDDGerRel.ChildBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  printBand := qryLocali.fieldByname('meta').asString <> '';
end;

procedure TfrmUnoQDDGerRel.ColumnHeaderBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
   lbano.Caption := ' - Exercício '+qryParametroexercicio.AsString;
end;

procedure TfrmUnoQDDGerRel.ColumnHeaderBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
   lbano.Caption := ' - Exercício '+qryParametroexercicio.AsString;
end;
