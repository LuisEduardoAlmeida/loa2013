object frmConsNatDesp: TfrmConsNatDesp
  Left = 0
  Top = 178
  Width = 1027
  Height = 479
  ...
  object qryGrupo: TADOQuery
    ...
    SQL.Strings = (
      ...
      '       seguridade = SUM(seguridade)  '
      ' FROM orcamento o'
      '   left outer JOIN elDespesa e ON o.grupoD = e.codigo'
      '          WHERE cat = :cat'
  ...
  object qrySubGrupo: TADOQuery
    ...
    SQL.Strings = (
      'SELECT cat, grupo, mod, modD, despesaD = e.descricao,'
      '       total = SUM(valor),'
      '       fiscal = SUM(fiscal),'
      '       seguridade = SUM(seguridade)  '
      ' FROM orcamento o'
      '   left outer JOIN elDespesa e ON o.modD = e.codigo'
      '        WHERE cat = :cat AND grupo = :grupo'
      '      GROUP BY cat, grupo, mod, modD, e.descricao'
      '          ORDER BY mod')
    Left = 72
    Top = 8
  ...
  object qry: TADOQuery
    ...
    SQL.Strings = (
      ...
      '       seguridade = SUM(seguridade)  '
      ' FROM orcamento o'
      '   left outer  JOIN elDespesa e ON o.elDespesa = e.codigo'
      '        WHERE cat = :cat AND grupo = :grupo AND mod = :mod'
      '      '
